...
export function RecoveryPage() {
    ...
    try {
      ...
      if (response.success) {
        ...
        notifications.show({
          ...
          message:
            "If an account exists with this email, we've sent a recovery code",
          color: "green",
  ...
  const handleVerifyCode = async () => {
    ...
    try {
      const response = await authApiService.verifyRecoveryCode(
        email,
        verificationCode,
      );
      ...
      if (response.success) {
        ...
        notifications.show({
          ...
          message:
            "Your account has been recovered. You can now sign in with email.",
          color: "green",
              ...
              <Paper withBorder p="md" radius="md">
                <Stack gap="xs">
                  ...
                  <List size="sm" spacing="xs">
                    ...
                    <List.Item>
                      You'll verify your identity with the code
                    </List.Item>
                    <List.Item>We'll confirm your account recovery</List.Item>
                    <List.Item>
                      You can sign in again with email verification
                    </List.Item>
                  </List>
                </Stack>
              </Paper>
        ...
        return (
          <Stack gap="md">
            ...
            <Alert color="orange" variant="light">
              <Text size="sm">
                <strong>Security Note:</strong> Verifying this code will sign
                out all your devices for security.
              </Text>
            </Alert>
          </Stack>
        );
  ...
  return <Stack gap="xl">{renderStep()}</Stack>;
}
