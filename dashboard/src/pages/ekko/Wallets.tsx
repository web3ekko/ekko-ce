...
export default function Wallets() {
  ...
  const handleSubmit = async (values: WalletFormValues) => {
    try {
      setLoading(true);
      // Create a wallet object that matches the backend model
      ...
      console.log('Submitting wallet:', newWallet);
  ...
  const handleToggleStatus = async (wallet: Wallet) => {
    try {
      ...
      await WalletService.updateWallet(wallet.id, { status: newStatus });
      fetchWallets();
    } catch (err) {
