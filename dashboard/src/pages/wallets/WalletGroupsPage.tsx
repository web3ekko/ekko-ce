...
export function WalletGroupsPage() {
  ...
  const openEditForGroup = async (group: GenericGroup) => {
    ...
    try {
      ...
      const settings = fullGroup.settings as
        { visibility?: string; color?: string; icon?: string } | undefined;

      setSelectedGroup(fullGroup);
      setFormName(fullGroup.name);
      setFormDescription(fullGroup.description || "");
      setFormVisibility(
        (settings?.visibility === "public" ? "public" : "private") as
          "private" | "public",
      );
      ...
      >
        <Stack>
          ...
          <Select
            ...
            onChange={(value) =>
              setFormVisibility(value === "public" ? "public" : "private")
            }
            required
          />
          <Select
          ...
          <MultiSelect
            ...
            placeholder={
              walletKeyOptions.length
                ? "Select wallets from Accounts…"
                : "Add wallets to Accounts first"
            }
