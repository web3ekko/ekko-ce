              ...
              <Group gap="xl" mt="lg">
                <div>
                  ...
                  <Text size="xl" fw={700}>
                    ...
                    {currentPlan.billing_cycle === "yearly" ? "yr" : "mo"}
                  </Text>
                </div>
            ...
            <Grid>
              ...
              <Grid.Col span={{ base: 12, md: 6 }}>
                ...
                >
                  <Group justify="space-between" mb="md">
                    ...
                    <Badge
                      color={getUsageColor(
                        usage.wallets.percent,
                        usage.wallets.unlimited,
                      )}
                      variant="light"
                    >
                      {usage.wallets.unlimited
                        ? "Unlimited"
                        : `${usage.wallets.percent}% used`}
                    </Badge>
                  </Group>
                  <Progress
                  ...
                  <Text size="sm" c="#475569">
                    {usage.wallets.unlimited
                      ? `${usage.wallets.used} wallets`
                      : `${usage.wallets.used} / ${usage.wallets.limit} wallets`}
                  </Text>
                </Card>
              </Grid.Col>
                ...
                >
                  <Group justify="space-between" mb="md">
                    ...
                    >
                      {usage.api_calls.unlimited
                        ? "Unlimited"
                        : `${usage.api_calls.percent}% used`}
                    </Badge>
                  </Group>
                  <Progress
                    value={
                      usage.api_calls.unlimited ? 0 : usage.api_calls.percent
                    }
                    color={getUsageColor(
                      usage.api_calls.percent,
                      usage.api_calls.unlimited,
                ...
                >
                  <Group justify="space-between" mb="md">
                    ...
                    >
                      {usage.notifications.unlimited
                        ? "Unlimited"
                        : `${usage.notifications.percent}% used`}
                    </Badge>
                  </Group>
                  <Progress
                    value={
              ...
              {!usage.alerts.unlimited && usage.alerts.percent >= 75 && (
                <Grid.Col span={12}>
                  ...
                  >
                    You've used {usage.alerts.percent}% of your monthly alert
                        ...
                        <Box mt="auto">
                          {isCurrent ? (
                            ...
                            <Button
                              ...
                              color="blue"
                              variant={
                                plan.price_usd > currentPlan.price_usd
                                  ? "filled"
                                  : "light"
                              }
