...
export function DashboardHome() {
  ...
  const [chainSummary, setChainSummary] = useState<
    ChainStatsResponse["summary"] | null
  >(null);
  ...
  useEffect(() => {
    ...
    if (showWelcome === "true") {
      notifications.show({
        ...
        message:
          "Your account has been created successfully. Start by setting up your first blockchain monitoring alert.",
        color: "teal",
        ...
        <Grid>
          <Grid.Col span={{ base: 12, md: 4 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              ...
              <Text size="sm" c="dimmed">
                {stats?.alerts.total
                  ? `${stats.alerts.total} total alerts`
                  : "No alerts yet"}
              </Text>
            </Card>
          </Grid.Col>
          ...
          <Grid.Col span={{ base: 12, md: 4 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              ...
              <Text size="sm" c="dimmed">
                {chainSummary?.total_chains
                  ? "Networks with active monitoring"
      ...
      <Card shadow="sm" padding="lg" radius="md" withBorder>
        <Stack gap="md">
          <Group justify="space-between">
            ...
            <Badge
              color={isChecklistComplete ? "green" : "blue"}
              variant="light"
            >
