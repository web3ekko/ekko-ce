...
export function buildTargetingVariableIds(
  alertType: AlertTargetType,
): Set<string> {
  const base = new Set([
    "network",
    "networks",
...
export function getTemplateTargetType(
  template: Pick<TemplateLike, "template_type" | "alert_type">,
): AlertTargetType {
...
export function getTemplateRequiredParamIds(
  template: TemplateLike,
): Set<string> {
