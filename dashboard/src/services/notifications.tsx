...
class NotificationService {
   ...
   */
  showCritical(
    options: Omit<NotificationOptions, "priority" | "severity">,
  ): string {
    return this.show({
      ...options,
      severity: "critical",
        ...
        root: {
          "&[data-mantine-notification]": {
            animation: this.reducedMotion
              ? "none"
              : "alertDrop 0.6s cubic-bezier(0.175, 0.885, 0.32, 1.275)",
          },
        },
      },
    });
...
export function useNotifications() {
  return {
    ...
    isSoundEnabled:
      notificationService.isSoundEnabled.bind(notificationService),
  };
}
