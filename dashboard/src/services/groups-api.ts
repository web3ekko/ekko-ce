...
export type NotificationRoutingChoice =
  "callback_only" | "user_channels" | "both";
...
class GroupsApiService {
  ...
  async getGroupsSplit(
    params: GroupsListParams = {},
  ): Promise<GroupsSplitResponse> {
    try {
      const response = await httpClient.get<GroupsSplitResponse>(
        API_ENDPOINTS.GROUPS.LIST,
        params,
      );
      return response.data;
  ...
  async getPublicGroups(
    ...
    try {
      const response = await httpClient.get<
        PaginatedResponse<GenericGroup> | GenericGroup[]
      >(API_ENDPOINTS.GROUPS.PUBLIC, params);
  ...
  async getGroupsSummary(): Promise<GroupsSummary> {
    try {
      const response = await httpClient.get<GroupsSummary>(
  ...
  async createGroup(data: CreateGroupRequest): Promise<GenericGroup> {
    try {
      ...
      const response = await httpClient.post<GenericGroup>(
  ...
  async listMembers(groupId: string): Promise<GroupMembersResponse> {
    try {
      const response = await httpClient.get<GroupMembersResponse>(
        API_ENDPOINTS.GROUPS.LIST_MEMBERS(groupId),
      );
      return response.data;
    } catch (error: unknown) {
  ...
  async getSubscriptions(
    ...
    try {
      const response = await httpClient.get<
        PaginatedResponse<GroupSubscription>
      >(API_ENDPOINTS.SUBSCRIPTIONS.LIST, params);
      return response.data;
    } catch (error: unknown) {
  ...
  async addWalletToAccounts(
    data: AccountsAddWalletRequest,
  ): Promise<AccountsAddWalletResponse> {
    try {
  ...
  async addWalletsToAccounts(
    data: AccountsAddWalletsRequest,
  ): Promise<AccountsAddWalletsResponse> {
    try {
  ...
  async getAlertGroupTemplates(
    alertGroupId: string,
  ): Promise<AlertGroupTemplatesResponse> {
    try {
  ...
  async getDefaultNetworkAlerts(): Promise<
    PaginatedResponse<DefaultNetworkAlert>
  > {
    try {
      const response = await httpClient.get<
        PaginatedResponse<DefaultNetworkAlert>
  ...
  async toggleDefaultNetworkAlert(
    id: string,
    enabled: boolean,
  ): Promise<DefaultNetworkAlert> {
    try {
