...
export type NewsfeedTransactionType =
  "TRANSFER" | "CONTRACT_CALL" | "CONTRACT_CREATE" | "INTERNAL" | "UNKNOWN";
...
// Transaction status
export type NewsfeedTransactionStatus = "SUCCESS" | "FAILED" | "PENDING";
...
export function getTransactionDirection(
  ...
  if (
    tx.transaction_type === "CONTRACT_CALL" ||
    tx.transaction_type === "CONTRACT_CREATE"
  ) {
    return "contract";
  }
