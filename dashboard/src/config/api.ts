...
export const API_ENDPOINTS = {
  ...
  PROFILE: {
    ...
    CONNECTED_SERVICE_DETAIL: (id: string) =>
      `/api/v1/profile/connected-services/${id}/`,
  ...
  ANALYTICS: {
    ...
    TABLE_SCHEMA: (tableName: string) =>
      `/api/v1/analytics/tables/${tableName}/schema/`,
    WALLET_TRANSACTIONS: (address: string) =>
      `/api/v1/analytics/wallet/${address}/transactions/`,
    WALLET_TRANSFERS: (address: string) =>
      `/api/v1/analytics/wallet/${address}/transfers/`,
    WALLET_BALANCES: (address: string) =>
      `/api/v1/analytics/wallet/${address}/balances/`,
    BLOCK_INFO: (blockNumber: number) =>
      `/api/v1/analytics/block/${blockNumber}/`,
    TOKEN_PRICES: (tokenAddress: string) =>
      `/api/v1/analytics/token/${tokenAddress}/prices/`,
  ...
  NOTIFICATIONS: {
    ...
    CHANNEL_REQUEST_VERIFICATION: (id: string) =>
      `/api/notifications/channels/${id}/request_verification/`,
    CHANNEL_RESEND_VERIFICATION: (id: string) =>
      `/api/notifications/channels/${id}/resend_verification/`,
