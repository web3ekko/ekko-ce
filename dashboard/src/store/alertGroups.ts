  ...
  persist(
    (set, get) => ({
      ...
      loadGroups: async () => {
        ...
        try {
          const response = await groupsApiService.getGroupsSplit({
      ...
      createGroup: async (name: string, description?: string) => {
        try {
          const newGroup = await groupsApiService.createAlertGroup(
            name,
            description,
          );
          set((state) => ({
      ...
      updateGroup: async (
        ...
        try {
          const updatedGroup = await groupsApiService.updateGroup(
            groupId,
            data,
          );
          set((state) => ({
      ...
      toggleSubscription: async (subscriptionId: string) => {
        try {
          const updatedSubscription =
            await groupsApiService.toggleSubscription(subscriptionId);
          set((state) => ({
...
export const selectSubscriptions = (state: AlertGroupsState) =>
  state.subscriptions;
...
export const selectIsSubscribed =
  (groupId: string) => (state: AlertGroupsState) =>
