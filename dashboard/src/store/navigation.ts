...
export const selectNavigationItems = (state: NavigationStore) =>
  state.navigationItems;
export const selectExpandedSections = (state: NavigationStore) =>
  state.expandedSections;
export const selectRecentPaths = (state: NavigationStore) => state.recentPaths;
export const selectIsNavigating = (state: NavigationStore) =>
  state.isNavigating;
