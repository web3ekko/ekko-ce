...
export const lightTheme = createTheme({
  ...
  other: {
    ...
    gradientCardDefault:
      "linear-gradient(135deg, rgba(255, 255, 255, 0.95) 0%, rgba(250, 250, 251, 0.98) 100%)",
    gradientCardElevated:
      "linear-gradient(135deg, rgba(255, 255, 255, 1) 0%, rgba(252, 252, 252, 1) 100%)",
    gradientCardInteractive:
    ...
    gradientEthereum:
      "linear-gradient(135deg, rgba(98, 126, 234, 0.05) 0%, rgba(98, 126, 234, 0.02) 100%)",
    gradientBitcoin:
      "linear-gradient(135deg, rgba(247, 147, 26, 0.05) 0%, rgba(247, 147, 26, 0.02) 100%)",
    gradientSolana:
      "linear-gradient(135deg, rgba(0, 255, 163, 0.05) 0%, rgba(0, 255, 163, 0.02) 100%)",

    // Colored shadows for brand elements
    shadowPrimary:
      "0 8px 18px rgba(37, 99, 235, 0.2), 0 4px 10px rgba(37, 99, 235, 0.12)",
    shadowPrimaryHover:
      "0 12px 22px rgba(37, 99, 235, 0.24), 0 6px 12px rgba(37, 99, 235, 0.16)",
    shadowSuccess:
      "0 6px 12px rgba(16, 185, 129, 0.18), 0 4px 10px rgba(16, 185, 129, 0.12)",
    shadowError:
      "0 6px 12px rgba(239, 68, 68, 0.2), 0 4px 10px rgba(239, 68, 68, 0.14)",
  ...
  components: {
    ...
    Card: {
      ...
      styles: {
        root: {
          background:
            "linear-gradient(135deg, rgba(255, 255, 255, 0.97) 0%, rgba(250, 250, 251, 0.99) 100%)",
          border: "1px solid var(--mantine-color-gray-2)",
          transition: "all 200ms cubic-bezier(0.4, 0, 0.2, 1)",
          "&:hover": {
            borderColor: "var(--mantine-color-gray-4)",
            boxShadow:
              "0 6px 12px rgba(0, 0, 0, 0.05), 0 3px 6px rgba(0, 0, 0, 0.02)",
    ...
    Notification: {
      ...
      styles: {
        root: {
          ...
          border: "1px solid var(--mantine-color-gray-3)",
          boxShadow:
            "0 10px 15px rgba(0, 0, 0, 0.06), 0 4px 6px rgba(0, 0, 0, 0.03)",
        },
      },
    },
