...
function mapChainStatsToData(stats: ChainStats): ChainData {
  ...
  const chainId =
    normalizedKey || stats.chain.toLowerCase().replace(/[^a-z]/g, "");
  const activeRatio =
    stats.alerts.total > 0
      ? (stats.alerts.active / stats.alerts.total) * 100
      : 100;
...
export function ChainMonitoringWidgets() {
  ...
  const operationalCount = chains.filter(
            ...
            <Center py="xl" flex={1}>
              <Stack align="center" gap="xs">
                ...
                <Text size="sm" fw={500} c="#0F172A">
                  No networks monitored yet
                </Text>
                <Text size="xs" c="dimmed" ta="center" maw={220}>
                  Blockchain status and metrics will appear here once monitoring
                  is active.
                </Text>
              </Stack>
            </Center>
                ...
                >
                  <Stack gap={8} h="100%">
                    ...
                    <Group
                      gap={4}
                      justify="center"
                      style={{ borderTop: "1px solid #F1F5F9", paddingTop: 8 }}
                    >
                      <Badge
                        size="xs"
                        variant="dot"
            ...
            <SimpleGrid cols={2} spacing="md">
              ...
              <Card padding="md" radius="md" withBorder>
                <Stack gap="xs">
                  ...
                  <Text size="xl" fw={700} c="#0F172A">
                    {selectedChain.avgBlockTime || "N/A"}
                  </Text>
                </Stack>
              </Card>
            </SimpleGrid>
                        ...
                        <div>
                          ...
                          <Text size="xs" c="#64748B">
                            {chain.tps === null
                              ? "TPS N/A"
                              : `${chain.tps} TPS`}{" "}
                            • {chain.avgBlockTime || "Block time N/A"}
                          </Text>
                        </div>
                      </Group>
                      <Group gap="md">
