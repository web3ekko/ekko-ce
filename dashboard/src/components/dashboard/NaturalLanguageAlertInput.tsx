...
const CATEGORY_META: Record<
  string,
  { color: string; icon: typeof IconWallet; label: string }
> = {
...
export function NaturalLanguageAlertInput({
  onInputClick,
}: NaturalLanguageAlertInputProps) {
      ...
      <Stack gap="xs">
        ...
        >
          <TextInput
            ...
            placeholder={
              placeholders[currentPlaceholder] || FALLBACK_PLACEHOLDER
            }
            size="lg"
            radius="lg"
