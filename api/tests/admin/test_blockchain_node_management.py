...
def admin_user(db):
    ...
    return User.objects.create_superuser(
        username="admin", email="admin@ekko.com", password="testpass123"
    )
...
class TestBlockchainNodeAdmin:
    ...
    def test_enable_disable_actions(
        self, blockchain_node_admin, admin_request, sample_nodes
    ):
    ...
    def test_run_health_check_action(
        self, blockchain_node_admin, admin_request, sample_nodes
    ):
    ...
    def test_export_to_nats_action(
        self, blockchain_node_admin, admin_request, sample_nodes
    ):
