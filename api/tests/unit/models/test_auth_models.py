...
class TestUserModel(TestCase):
    ...
    def test_user_creation(self):
        ...
        self.assertEqual(
            user.full_name, f"{self.test_first_name} {self.test_last_name}"
        )
    ...
    def test_user_unique_email(self):
        ...
        User.objects.create_user(
            email="unique@example.com", first_name="First", last_name="User"
        )

        with self.assertRaises(IntegrityError):
            User.objects.create_user(
                email="unique@example.com", first_name="Second", last_name="User"
            )

    def test_user_passwordless_auth(self):
        """Test that users have unusable passwords by default"""
        user = User.objects.create_user(
            email="passwordless@example.com", first_name="Test", last_name="User"
        )
    ...
    def test_user_timestamps(self):
        ...
        before = timezone.now()
        user = User.objects.create_user(
            email="timestamp@example.com", first_name="Time", last_name="Stamp"
        )
        after = timezone.now()
    ...
    def test_user_auth_preferences(self):
        ...
        user = User.objects.create_user(
            email="prefs@example.com", first_name="Pref", last_name="User"
        )
    ...
    def test_user_email_verification_status(self):
        ...
        verified_user = User.objects.create_user(
            email="verified@example.com", first_name="Verified", last_name="User"
        )
        ...
        unverified_user = User.objects.create_user(
            email="unverified@example.com", first_name="Unverified", last_name="User"
        )
...
class TestUserDeviceModel(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            email="device@example.com", first_name="Device", last_name="User"
        )
...
class TestAuthenticationLogModel(TestCase):
    ...
    def test_auth_log_methods(self):
        ...
        for method in methods:
            log = AuthenticationLog.objects.create(
                user=self.user, method=method, success=True, ip_address="192.168.1.1"
            )
...
class TestEmailVerificationCodeModel(TestCase):
    ...
    def setUp(self):
        """Set up test data before each test method"""
        self.user = User.objects.create_user(
            email="verify@example.com", first_name="Verify", last_name="User"
        )
...
class TestAuthModelRelationships(TestCase):
    ...
    def setUp(self):
        """Set up test data before each test method"""
        self.user = User.objects.create_user(
            email="relation@example.com", first_name="Relation", last_name="User"
        )
    ...
    def test_user_authentication_logs(self):
        ...
        AuthenticationLog.objects.create(
            user=self.user, method="passkey", success=True, ip_address="192.168.1.1"
        )
        ...
        successful_auths = self.user.auth_logs.filter(success=True)
    ...
    def test_cascade_deletion(self):
        ...
        log = AuthenticationLog.objects.create(
            user=self.user, method="email_code", success=True, ip_address="192.168.1.1"
        )
        code = EmailVerificationCode.objects.create(
            user=self.user,
            email=self.user.email,
...
class TestUserDevicePushTokenModel(TestCase):
    ...
    def setUp(self):
        """Set up test data before each test method"""
        self.user = User.objects.create_user(
            email="pushtoken@example.com", first_name="Push", last_name="User"
        )
    ...
    def test_multiple_devices_different_users(self):
        ...
        user2 = User.objects.create_user(
            email="pushtoken2@example.com", first_name="Push2", last_name="User2"
        )
        device2 = UserDevice.objects.create(
            user=user2,
...
class TestUserDeviceDeleteSignal(TestCase):
    ...
    def test_delete_preserves_other_users_push_cache(self):
        ...
        other_user = User.objects.create_user(
            email="other_push@example.com", first_name="Other", last_name="User"
        )
