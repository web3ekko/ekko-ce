...
class TestDashboardNetworkStatusView:
    ...
    def test_calculate_health_score_active(self):
        ...
        sub = {
            "state": "active",
            "metrics": {"connection_errors": 0, "processing_errors": 0},
        }
    ...
    def test_calculate_health_score_with_errors(self):
        ...
        sub = {
            "state": "active",
            "metrics": {"connection_errors": 5, "processing_errors": 3},
        }
    ...
    def test_calculate_health_score_max_penalty(self):
        ...
        sub = {
            "state": "active",
            "metrics": {"connection_errors": 50, "processing_errors": 50},
        }
    ...
    def test_transform_subscription(self):
        ...
        view = DashboardNetworkStatusView()
        provider = {"provider_id": "newheads-evm-pod1", "provider_type": "evm"}
        sub = {
            "chain_name": "Ethereum Mainnet",
            "state": "active",
            "last_block": {"number": 19283746, "received_at": "2024-01-15T10:30:45Z"},
            "metrics": {
