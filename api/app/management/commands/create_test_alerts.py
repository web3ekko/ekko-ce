...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if options["clear"]:
            ...
            self.stdout.write(
                self.style.WARNING(f"Cleared {deleted_count} existing test alerts")
            )
        ...
        for i in range(event_count):
            alert = AlertInstance.objects.create(
                ...
                spec={
                    ...
                    "trigger": {"mode": "event", "event_type": "transfer"},
                },
                enabled=True,
            )
            alerts_created += 1
        ...
        for i in range(periodic_count):
            ...
            alert = AlertInstance.objects.create(
                ...
                spec={
                    "scope": {"addresses": [], "chains": ["ethereum"], "contracts": []},
                    "filters": {},
                    "trigger": {"mode": "schedule", "schedule_type": "periodic"},
                },
                enabled=True,
            )
            alerts_created += 1
        ...
        for i in range(onetime_count):
            ...
            alert = AlertInstance.objects.create(
                ...
                spec={
                    "scope": {"addresses": [], "chains": ["ethereum"], "contracts": []},
                    "filters": {},
                    "trigger": {"mode": "schedule", "schedule_type": "one_time"},
                },
                enabled=True,
            )
            alerts_created += 1
