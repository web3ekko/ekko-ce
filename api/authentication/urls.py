...
urlpatterns = [
    ...
    path(
        ...
        views_verification.check_account_status,
    ...
    path(
        "signup/verify-code/",
        views_verification.signup_verify_code,
        name="signup_verify_code",
    ),
    path(
        "signup/passkey/register/",
        views.signup_passkey_register,
        name="signup_passkey_register",
    ),
    path("signup/passkey/skip/", views.signup_skip_passkey, name="signup_skip_passkey"),
    path(
        "signup/complete-dev/",
        views_verification.signup_complete_dev,
        name="signup_complete_dev",
    ),  # Development mode
    # Passwordless Login Options
    path("options/", views.auth_options, name="auth_options"),
    # Passkey Sign-in (Primary)
    path(
        "signin/passkey/begin/",
        views_verification.signin_passkey_begin,
        name="signin_passkey_begin",
    ),
    path(
        "signin/passkey/complete/",
        views_verification.signin_passkey_complete,
        name="signin_passkey_complete",
    ),
    # Email Code Sign-in (Fallback)
    path(
        "signin/email/send-code/",
        views_verification.signin_email_send_code,
        name="signin_email_send_code",
    ),
    path(
        "signin/email/verify-code/",
        views_verification.signin_email_verify_code,
        name="signin_email_verify_code",
    ),
    ...
    path(
        "recovery/request/",
        views_verification.recovery_request,
        name="recovery_request",
    ),
    path(
        "recovery/verify-code/",
        views_verification.recovery_verify_code,
        name="recovery_verify_code",
    ),
    path(
        "recovery/complete/",
        views.account_recovery_complete,
    ...
    path(
        ...
        views_firebase.firebase_token_exchange,
        name="firebase_token_exchange",
    ),
    path(
        "firebase/custom-token/",
        views_firebase.firebase_custom_token,
    ...
    path(
        "passkey/authenticate/", views.authenticate_passkey, name="authenticate_passkey"
    ),
    path("passkey/list/", views.list_passkeys, name="list_passkeys"),
    path(
        "passkey/<int:passkey_id>/delete/", views.delete_passkey, name="delete_passkey"
    ),
    ...
    path(
        "devices/register-push/", views.register_push_token, name="register_push_token"
    ),
    path(
        "devices/push-enabled/",
        views.list_push_enabled_devices,
        name="list_push_enabled_devices",
    ),
    path(
        "devices/<uuid:device_id>/push-token/",
        views.update_device_push_token,
        name="update_device_push_token",
    ),
    path(
        "devices/<uuid:device_id>/push-token/revoke/",
        views.revoke_device_push_token,
        name="revoke_device_push_token",
    ),
    path(
        "devices/<uuid:device_id>/push-enabled/",
        views.toggle_device_push,
        name="toggle_device_push",
    ),
