...
class WebAuthnIntegrationTest(APITestCase):
    ...
    def test_authenticate_passkey_endpoint_exists(self):
        ...
        response = self.client.post(
            url,
            {"email": "test@example.com", "device_info": {"webauthn_supported": True}},
            content_type="application/json",
        )
    ...
    def test_delete_passkey_endpoint(self):
        ...
        url = reverse(
            "authentication:delete_passkey", kwargs={"passkey_id": authenticator.id}
        )
    ...
    def test_login_flow_includes_webauthn_options(self):
        ...
        response = self.client.post(
            login_url,
            {
                "email": "test@example.com",
                "auth_method": "passkey",
                "device_info": {"webauthn_supported": True},
            },
            content_type="application/json",
        )
