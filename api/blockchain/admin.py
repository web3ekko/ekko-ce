...
class TokenAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Token Information", {"fields": ("symbol", "name", "decimals")}),
        ("Chain & Type", {"fields": ("chain", "is_native", "contract_address")}),
        (
            "Timestamps",
    ...
    def is_native_display(self, obj):
        ...
        if obj.is_native:
            return format_html(
                '<span style="color: green; font-weight: bold;">✓ Native</span>'
            )
