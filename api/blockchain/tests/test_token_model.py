...
class TokenModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.ethereum = Chain.objects.create(
            name="ethereum", display_name="Ethereum", chain_id=1, enabled=True
        )

        self.polygon = Chain.objects.create(
            name="polygon", display_name="Polygon", chain_id=137, enabled=True
        )
    ...
    def test_redis_key_generation(self):
        ...
        self.assertEqual(
            eth_token.get_redis_key("mainnet"), "native_token:ethereum:mainnet"
        )
        self.assertEqual(
            eth_token.get_redis_key("testnet"), "native_token:ethereum:testnet"
        )
