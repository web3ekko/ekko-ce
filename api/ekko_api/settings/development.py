...
DATABASES = {
    "default": dj_database_url.config(
        default="postgresql://ekko:ekko123@postgres:5432/ekko_dev", conn_max_age=600
    )
}
...
if EMAIL_PROVIDER == "resend":
    ...
    DEFAULT_FROM_EMAIL = os.environ.get(
        "DEFAULT_FROM_EMAIL", EMAIL_HOST_USER or "noreply@ekko.dev"
    )
...
FIREBASE_AUTH_DOMAIN = os.environ.get(
    "FIREBASE_AUTH_DOMAIN", "ekko-testing.firebaseapp.com"
)
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [
                (REDIS_URL.replace("redis://", "").split("@")[1].split(":")[0], 6379)
            ],
        },
    },
}
