...
DATABASES = {
    "default": env.db_url(
        "DATABASE_URL", default="postgresql://ekko:ekko@postgres:5432/ekko_api"
    )
}
...
AUTH_EMAIL_MAGIC_LINK_ENABLED = (
    os.environ.get("AUTH_EMAIL_MAGIC_LINK_ENABLED", "True").lower() == "true"
)
